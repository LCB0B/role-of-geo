...
fig = plt.figure(layout="constrained",figsize=(18.3*cm, 10*cm))

gs1 = GridSpec(2, 1, figure=fig,right=0.4,wspace=0,hspace=0)
...
ax2.plot(x_r,y_r,'-',color='k',label='intrinsic distance cost')
slope= 0.98
...
ax11.plot(x,y,zorder=2,color = 'k',label='intrinsic distance cost ')
...
gs1.update(right=0.325,wspace=0.3,top=0.96, hspace=0.25)
...
# save
plt.tight_layout()
plt.savefig(f'figures/figure_3.png',dpi=300)
plt.savefig(f'figures/figure_3.pdf')
